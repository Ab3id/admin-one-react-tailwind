  ...
  const componentChildren = (
    <>
      {icon && <Icon path={icon} size={iconSize} />}
      {
        isLoading &&
        <div role="status">
            <svg aria-hidden="true" className="w-5 h-5 text-gray-200 animate-spin dark:text-white-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {label && (
        <span className={small && icon ? "px-1" : "px-2"}>
